    ...
    postDBLoad(container) {
        ...
        for (const weapon in dbMastering) {
            if (dbMastering[weapon].Name == "M4")
                dbMastering[weapon].Templates.push("0101_BLACK_LINES_M4A1", "0106_FLAMING_M4A1", "0107_PRISTINE_M4A1");
            if (dbMastering[weapon].Name == "AK74")
                dbMastering[weapon].Templates.push("0102_BLACK_LINES_AK103");
            if (dbMastering[weapon].Name == "R11SRASS")
                dbMastering[weapon].Templates.push("0103_BLACK_RSASS");
            if (dbMastering[weapon].Name == "MK47")
                dbMastering[weapon].Templates.push("0104_BLACK_LINES_MK47");
            if (dbMastering[weapon].Name == "AUG")
                dbMastering[weapon].Templates.push("0105_BLACK_AUG");
            if (dbMastering[weapon].Name == "SPEAR")
                dbMastering[weapon].Templates.push("0108_BLACK_SPEAR");
        }
        this.logger.info("------------------------");
